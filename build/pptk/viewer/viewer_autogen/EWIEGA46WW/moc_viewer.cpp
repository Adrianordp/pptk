...
QT_MOC_LITERAL(1, 7, 5), // "reply"
QT_MOC_LITERAL(2, 13, 0), // ""
QT_MOC_LITERAL(3, 14, 24), // "drawRefinedPointsDelayed"
QT_MOC_LITERAL(4, 39, 17), // "drawRefinedPoints"
QT_MOC_LITERAL(5, 57, 19) // "playCameraAnimation"

    },
    "Viewer\0reply\0\0drawRefinedPointsDelayed\0"
    "drawRefinedPoints\0playCameraAnimation"
};
...
void Viewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->reply(); break;
        case 1: _t->drawRefinedPointsDelayed(); break;
        case 2: _t->drawRefinedPoints(); break;
        case 3: _t->playCameraAnimation(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
void *Viewer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "OpenGLFuncs"))
        return static_cast< OpenGLFuncs*>(this);
